<?php
    ...
    if(isset($_SESSION['user'])){
        ...
        $datosdevice = $_SESSION['updatedevice'];
...
<head>
    <meta charset="utf-8" />
    <title>Actualizar equipos | Sysmaint</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row ">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="header-title">Actualizar equipos</h4>
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <form method="POST" action="api-device/updDevice.php">

                                                <div class="mb-3">
                                                    <label for="simpleinput" class="form-label">Nombre del
                                                        dispositivo</label>
                                                    <input type="text" id="simpleinput" class="form-control"
                                                        name="device-name" value="<?php echo $datosdevice['name']; ?>">
                                                </div>
                                                ...
                                                <div class=" mb-3">
                                                    ...
                                                    <input type="text" id="simpleinput" class="form-control"
                                                        name="device-brand"
                                                        value="<?php echo $datosdevice['brand']; ?>">
                                                </div>
                                                ...
                                                <div class=" mb-3">
                                                    ...
                                                    <input type="text" id="simpleinput" class="form-control"
                                                        name="device-model"
                                                        value="<?php echo $datosdevice['model']; ?>">
                                                </div>
                                                ...
                                                <div class=" mb-3">
                                                    ...
                                                    <input type="text" id="simpleinput" class="form-control"
                                                        ...
                                                        value="<?php echo $datosdevice['serial_number']; ?>">
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" id="example-date" type="date"
                                                        ...
                                                        value="<?php echo $datosdevice['purchase_date']; ?>">
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" id="simpleinput" class="form-control"
                                                        ...
                                                        value="<?php echo $datosdevice['location']; ?>">
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select" id="example-select"
                                                        name="device-status">
                                                        <?php
                                                        $estados = array('Activo', 'Inactivo', 'Mantenimiento');
                                                        foreach ($estados as $estado) {
                                                            if ($estado == $datosdevice['physical_state']) {
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" id="example-textarea" rows="3"
                                                        name="device-status-description"><?php echo $datosdevice['status_description']; ?></textarea>
                                                </div>
                                        </div> <!-- end col -->
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="mb-3">
                                                <label for="example-textarea" class="form-label">Especificaciones
                                                    técnicas</label>
                                                <textarea class="form-control" id="example-textarea" rows="5"
                                                    name="device-specifications"><?php echo $datosdevice['technical_specifications']; ?></textarea>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" id="example-date" type="date"
                                                    ...
                                                    value="<?php echo $datosdevice['installation_date']; ?>">
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" id="example-select" name="device-garantia">
                                                    <?php
                                                        $garantias = array('Sí', 'No');
                                                        foreach ($garantias as $garantia) {
                                                            if ($garantia == $datosdevice['garantia']) {
                                                                echo "<option selected>$garantia</option>";
                                                            } else {
                                                                echo "<option selected>$garantia</option>";
                                                            }
                                                        }
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" id="example-select"
                                                    ...
                                                    <?php
                                                        $accesorios = array('Si', 'No');
                                                        foreach ($accesorios as $accesorio) {
                                                            if ($accesorio == $datosdevice['garantia']) {
                                                                echo "<option selected>$accesorio</option>";
                                                            } else {
                                                                echo "<option selected>$accesorio</option>";
                                                            }
                                                        }
                                            ...
                                            <div class="mb-3">
                                                <label for="simpleinput" class="form-label">Valor del
                                                    dispositivo</label>
                                                <input type="number" id="simpleinput" class="form-control" min="1"
                                                    name="current_value"
                                                    value="<?php echo $datosdevice['current_value']; ?>">
                                            </div>
                                        ...
                                        <div class="mb-3">
                                            <button type="submit" class="btn btn-primary" name="submit">Actualizar
                                                Datos</button>
                                        </div>
                                        </form>
                                    </div>
